          ...
          <div class="rounded-t mb-0 px-6 py-6">
            ...
            <form @submit.prevent="submit">
              <div class="relative w-full mb-3">
                ...
                <auth-input label="Password" forLabel="password" id="password" type="password" class="dark:bg-gray-600 dark:text-white mt-1 block w-full" v-model="form.password" required autocomplete="current-password" autofocus />
              </div>
